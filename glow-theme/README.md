...
- **Version:** 2.0.0 · **Author:** CloudIA · **Text domain:** `glow-glow`
- **Requires:** WordPress 6.0+, PHP 7.4+, WooCommerce 7.0+

## Installation

1. **Install the theme.** Zip the `glow-theme` folder, then in WP Admin go
...
2. **Ensure WooCommerce is active**, then import the bundled dummy data
   ...
   ```
   wp eval-file wp-content/themes/glow-theme/dummy-products.php
   ```
