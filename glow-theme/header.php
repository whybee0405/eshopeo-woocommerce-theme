...
<header class="site-header" data-header>
	<div class="container header-grid">
		...
		<div class="header-utils">
			<button class="util-btn search-toggle" type="button" aria-label="<?php esc_attr_e( 'Search products', 'glow-glow' ); ?>" aria-expanded="false" data-search-toggle>
			...
			<?php if ( glow_wc_active() ) : ?>
				<a class="util-btn" href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" aria-label="<?php esc_attr_e( 'My account', 'glow-glow' ); ?>">
				...
				<a class="util-btn cart-link" href="<?php echo esc_url( wc_get_cart_url() ); ?>" aria-label="<?php esc_attr_e( 'Shopping bag', 'glow-glow' ); ?>">
			...
			<button class="util-btn menu-toggle" type="button" aria-label="<?php esc_attr_e( 'Open menu', 'glow-glow' ); ?>" aria-expanded="false" data-menu-toggle>
	...
	<div class="nav-flyout" hidden data-flyout>
		<div class="container flyout-inner">
			...
			<div class="flyout-col">
				<p class="flyout-label"><?php esc_html_e( 'By Routine', 'glow-glow' ); ?></p>
			...
			<div class="flyout-col">
				<p class="flyout-label"><?php esc_html_e( 'By Ingredient', 'glow-glow' ); ?></p>
				<ul class="flyout-list">
					<?php
					$glow_flyout_ings = array(
						array( __( 'Snail mucin', 'glow-glow' ), 'snail mucin' ),
						array( __( 'Centella asiatica', 'glow-glow' ), 'centella' ),
						array( __( 'Niacinamide', 'glow-glow' ), 'niacinamide' ),
						array( __( 'Hyaluronic acid', 'glow-glow' ), 'hyaluronic' ),
						array( __( 'Rice extract', 'glow-glow' ), 'rice extract' ),
					);
...
<div class="mobile-menu" data-mobile-menu hidden>
	...
	<nav aria-label="<?php esc_attr_e( 'Mobile', 'glow-glow' ); ?>">
		<p class="mobile-section-head"><?php esc_html_e( 'Shop', 'glow-glow' ); ?></p>
		<ul class="mobile-shop-links">
			<li><a href="<?php echo esc_url( glow_wc_active() ? wc_get_page_permalink( 'shop' ) : home_url( '/' ) ); ?>"><?php esc_html_e( 'All products', 'glow-glow' ); ?></a></li>
			<li><a href="<?php echo esc_url( home_url( '/#routine' ) ); ?>"><?php esc_html_e( 'By Routine', 'glow-glow' ); ?></a></li>
			<li><a href="<?php echo esc_url( home_url( '/#concerns' ) ); ?>"><?php esc_html_e( 'By Concern', 'glow-glow' ); ?></a></li>
