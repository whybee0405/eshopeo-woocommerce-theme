	...
	<div class="container">
		...
		<div class="footer-grid">
			<div class="footer-brand">
				...
				<p><?php esc_html_e( 'Authentic Korean skincare, organised by the routine that makes it work. Sourced in Seoul, verified batch by batch, shipped from Johannesburg.', 'glow-glow' ); ?></p>
			</div>
		...
		<div class="footer-bottom">
			<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?> · <?php esc_html_e( 'Johannesburg, South Africa', 'glow-glow' ); ?></p>
			<div class="payment-badges" aria-label="<?php esc_attr_e( 'Accepted payment methods', 'glow-glow' ); ?>">
				<span>PayFast</span>
				<span>Visa</span>
