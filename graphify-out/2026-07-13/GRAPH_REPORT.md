# Graph Report - cosmetics-woocommerce-theme  (2026-07-13)

## Corpus Check
- 369 files · ~3,579,007 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4639 nodes · 5311 edges · 479 communities (397 shown, 82 thin omitted)
...
- [[_COMMUNITY_Prerequisites|Prerequisites]]
- [[_COMMUNITY_generate_html|generate_html]]
- [[_COMMUNITY_Glow_Hero_Stage_Widget|Glow_Hero_Stage_Widget]]
...
## Communities (479 total, 82 thin omitted)
...
### Community 441 - "primary-foreground"
Cohesion: 0.67
...
### Community 464 - "primary-foreground"
Cohesion: 0.67
...
- **Why does `primitive` connect `design-tokens-starter.json` to `primitive`, `Glow_Concern_Tiles_Widget`, `spacing`, `fontSize`, `radius`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `TailwindConfigGenerator` connect `TailwindConfigGenerator` to `._base_config`, `.test_write_config_creates_content`, `TestTailwindConfigGenerator`, `.generate_config_string`, `test_tailwind_config_gen.py`, `.test_recommend_plugins`, `16`, `1`, `.test_init_default_typescript`, `radius`, `main`, `TestTailwindConfigGenerator`, `sm`, `.test_init_javascript`, `$type`, `test_tailwind_config_gen.py`, `16`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
